...
window.title("Ping Pong Game By Bavcii")
...
player1.shapesize(stretch_len=0.5, stretch_wid=7.5)
player1.color("blue")
player1.penup()
...
player2.shapesize(stretch_len=0.5, stretch_wid=7.5)
player2.color("red")
player2.penup()
...
window.onkeypress(p2_move_down, "d")
